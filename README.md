...
Sample applications have been created for the Google Drive, Google Mirror, Google Sheets and Dropbox libraries to demonstrate the use of this library within Salesforce.
